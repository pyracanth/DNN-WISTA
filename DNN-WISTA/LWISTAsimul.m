...
network.T1=15;
figno=50:1:60;
info.netlearn=1;% 1for supervised 2for unsupervised
info.p=0.7; 
switch info.p
    case 0.9
        lambda=2e-5;
        LEARNING_RATE.alpha=0e1;
        LEARNING_RATE.t0=20e2;
    case 0.7
        LEARNING_RATE.alpha=0e1;
        LEARNING_RATE.t0=30e2;
        info.lambda=6.5e-6;
    case 0.5
        LEARNING_RATE.alpha=0e1;
        LEARNING_RATE.t0=40e2;
        lambda=2e-6;
end
...
[network, Z, Z0, ZT, info]=DNNWista_trainfull(D,Xtrain,Zorig,network, info, NUM_CLASSES,...

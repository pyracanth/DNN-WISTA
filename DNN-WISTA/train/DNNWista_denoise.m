function [network, Z, Zstar, info] = DNNWista_denoise(D, X, network, info, num_of_classes, learning_rate, max_iter, conv_count_thres, error_check_iter )
...
if info.Zstarskip==0
    tic;
    [Zstar, info]=mass_Wistadn_fpropcg10(X,network.W,network.H,network.t, 500,info);
